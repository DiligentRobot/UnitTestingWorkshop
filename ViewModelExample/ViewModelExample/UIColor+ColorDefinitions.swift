//
//  UIColor+ColorDefinitions.swift
//  ViewModelExample
//
//  Created by Scotty on 17/09/2017.
//  Copyright © 2017 Diligent Robot. All rights reserved.
//

import UIKit

/// Add some ViewModelExample specific colors to UIColor.
extension UIColor {
    ...
    /// Pick a color based on an index in a list.
